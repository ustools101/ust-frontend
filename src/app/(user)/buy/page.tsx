      ...
      <div className="bg-gray-900 rounded-xl p-4 sm:p-6 max-w-lg w-full border border-gray-800 my-4 max-h-[90vh] overflow-y-auto">
        ...
        {paymentMethod === 'bank' ? (
          <div className="space-y-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 text-center border border-gray-700">
              <p className="text-gray-300 mb-2">
                To complete your purchase via Bank Transfer, please contact us on Telegram to get the current account details.
              </p>
            </div>
            ...
            <div className="bg-blue-900/20 border border-blue-800/50 rounded-lg p-4">
              ...
              <ol className="list-decimal ml-6 space-y-2 text-sm text-gray-300">
                <li>Click the button below to message us on Telegram</li>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-6 text-center border border-gray-700">
              <p className="text-gray-300 mb-2">
                To complete your purchase via USDT, please contact us on Telegram to get the wallet address.
              </p>
            </div>
