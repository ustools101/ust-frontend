...
export const metadata: Metadata = {
  title: 'Signup | Ultimate Social Tools',
  description: 'Join the elite. Access powerful ethical hacking tools for social media.',
};
      ...
      <div className="relative z-10 max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-secondary-800/50 backdrop-blur-sm border border-primary-500/20 p-8">
          ...
          <div className="flex items-center gap-2 mb-8 font-mono text-primary-400">
            ...
            <span className="ml-2">[root@ultimatesocial] # ./signup.sh</span>
          </div>

          <h2 className="text-2xl font-bold text-gray-100 mb-8">Create your account</h2>
